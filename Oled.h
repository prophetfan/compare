...
void OLED_Init(void)
{
        P1SEL &=  0xf3;//1111 0011普通io
        P1DIR |=  0x0c;//0000 1100输出
        
	delay(50);//初始化之前的延时很重要！
...
/*void Oled_write_data_3(unsigned char x,unsigned char y,int temp)
{
...
{	
	OLED_P8x16Str(33,2,"+");
		tp=temp;
    temp=tp*0.0625*100+0.5;	//如果温度是正的那么，那么正数的原码就是补码它本身
}
	//datas[] = ' ';
